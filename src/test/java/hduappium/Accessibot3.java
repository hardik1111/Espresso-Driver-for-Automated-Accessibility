...
public class Accessibot3 extends Baseclass12 {
	...
	public void accessibilityTest() throws InterruptedException, IOException
    {
    	...
    	WebElement search = driver.findElement(AppiumBy.accessibilityId("Show navigation drawer"));
    	Dimension size = getSizeInDp(search,dpi);
    	
    	System.out.print(size.height + " "+ size.width );
