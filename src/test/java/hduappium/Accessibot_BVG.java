...
public class Accessibot_BVG extends Baseclass_BVG {
	
	List<AccessibilityViolation2> allViolations = new ArrayList<>();
	
	private List<String> CDelementTypes = Arrays.asList(
	        ...
	        "android.widget.ToggleButton", "android.widget.Spinner", "android.widget.Switch", 
	        "android.widget.SeekBar", "android.widget.EditText", "android.widget.LinearLayout", 
	        "android.widget.FrameLayout", "android.widget.RelativeLayout"
	    );
	
	private List<String> TTelementTypes = Arrays.asList(
	...
	private List<String> FCelementTypes = Arrays.asList(
			"android.widget.ImageButton", "android.widget.TextView","android.widget.ImageView","android.widget.Button","android.widget.CheckBox","android.widget.RadioButton","android.widget.ToggleButton","android.widget.Spinner","android.widget.EditText","android.support.design.widget.TabLayout$TabView","android.widget.SeekBar","android.widget.Switch", "android.widget.LinearLayout", "android.widget.FrameLayout", "android.widget.RelativeLayout"
	    );
	
	private List<String> CvelementTypes = Arrays.asList(
			"android.widget.TextView","android.widget.Button","android.widget.CheckBox","android.widget.RadioButton","android.widget.EditText","android.widget.ImageButton","android.widget.Switch","android.widget.ToggleButton","android.widget.Spinner","android.widget.SeekBar","android.support.design.widget.TabLayout$TabView", "android.widget.ActionMenuView","android.widget.ListView", "android.widget.GridView","android.widget.LinearLayout", "android.widget.FrameLayout", "android.widget.RelativeLayout"
	    );
	
	private List<String> CONONelementTypes = Arrays.asList(
	...
	private List<String> INTelementTypes = Arrays.asList(
			"android.widget.ImageButton","android.widget.Button","android.widget.CheckBox","android.widget.RadioButton","android.widget.ToggleButton","android.widget.SeekBar","android.widget.Switch","android.widget.Spinner","android.widget.EditText","android.support.design.widget.TabLayout$TabView","androidx.drawerlayout.widget.DrawerLayout","android.widget.PopupMenu","android.view.Menu"
	    );
	
	private List<String> COTEXelementTypes = Arrays.asList(
	...
	public List<SavedElement> extractAndSaveElements(String combinedXpath) throws IOException, InterruptedException {
	    ...
	    while (retry) {
	        ...
	        try {
	            ...
	            while (lastIndexProcessed < elements.size()) {
	                ...
	                attributes.put("className", element.getAttribute("class"));
	                attributes.put("text", element.getText());
	                attributes.put("focusable", element.getAttribute("focusable"));
	                attributes.put("checkable", element.getAttribute("checkable"));
	                attributes.put("checked", element.getAttribute("checked"));
	                attributes.put("clickable", element.getAttribute("clickable"));
	                attributes.put("content-desc", element.getAttribute("content-desc"));
	                attributes.put("selected", element.getAttribute("selected"));
	                attributes.put("enabled", element.getAttribute("enabled"));
	                attributes.put("displayed", element.getAttribute("displayed"));
	    ...
	    private List<ChildElement> extractChildElements(WebElement parentElement) {
	        ...
	        for (WebElement childElement : childWebElements) {
	            ...
	            if (className.equals("android.widget.TextView") ||
	                ...
	                className.equals("android.widget.RadioButton") ||
	                className.equals("android.widget.ToggleButton") ||
	                className.equals("android.widget.EditText") ||
	                className.equals("android.widget.Switch") ||
	                className.equals("android.support.design.widget.TabLayout$TabView")) 
	            	{
	    ...
	    public void accessibilityTest() throws InterruptedException, IOException {
	        ...
	        performChecksForScreen("Map Filter",combinedXpath);
