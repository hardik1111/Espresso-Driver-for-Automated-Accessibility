...
public class Accessibot_TMR2 extends Baseclass_tmr {
	...
	private void navigateRequestOptions() throws InterruptedException {
		...
		driver.hideKeyboard();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Stanley Rd at Vince Herbert Field, stop 45, Greate, 15,935 km, Favorite No, departing transports, Bus 204, Bus 210, Bus 212, Bus 590, Bus 598, Bus 599, Bus P211, , \"]/android.view.View[1]")).click();
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
	}
	...
	private void navigateToTripResults() throws InterruptedException {
		...
		driver.hideKeyboard();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Ramsden Street, Carina, 15,934 km, , , \"]/android.view.View[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Ramsden Street, Carina, 15,934 km, Favorite No, , , \"]/android.view.View[1]")).click();
		...
		driver.hideKeyboard();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"35 Banwell Crescent, Brisbane, 15,937 km, Favorite No, , , \"]/android.view.View[1]")).click();
		Thread.sleep(5000);
	...
	private void navigateToTripDetails() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"6:21am\"])[1]")).click();
		Thread.sleep(5000);	
	}
