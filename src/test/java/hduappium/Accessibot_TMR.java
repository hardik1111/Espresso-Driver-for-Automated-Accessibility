...
public class Accessibot_TMR extends Baseclass_tmr {
	...
	private void collectAllElements() throws IOException, InterruptedException {
	    int minWidth = 44; // Minimum width threshold for element
	    int minHeight = 44; // Minimum height threshold for element
	...
	private void navigateToTutorialPage() throws InterruptedException {
		...
		driver.findElement(By.id("de.hafas.android.translink:id/button_tracking_optin_agree")).click();
    	Thread.sleep(5000);
	}
	...
	private void navigateToMorePage() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.id("de.hafas.android.translink:id/button_map_overlay_finish")).click();
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.FrameLayout[5]/android.widget.FrameLayout/android.widget.TextView")).click();
    	Thread.sleep(5000);
	}
	...
	private void navigateToStopsNearByPage() throws InterruptedException {
    	...
    	driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Stops nearby\"]/android.widget.TextView")).click();
    	Thread.sleep(5000);
	}
	...
	private void navigateEnterLocation() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
	...
	private void navigateVia() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		
	
		driver.findElement(By.id("de.hafas.android.translink:id/button_via")).click();
    	Thread.sleep(5000);
	}
	
	private void navigateRequestOptions() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		
	
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText")).click();
		WebElement EditText = driver.findElement(By.id("de.hafas.android.translink:id/input_location_name"));
		EditText.sendKeys("Stanley Rd at Vince");
		driver.hideKeyboard();
		Thread.sleep(10000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Stanley Rd at Vince Herbert Field, stop 45, Greate, 11,413 km, Favorite No, departing transports, Bus 204, Bus 210, Bus 212, Bus 590, Bus 598, Bus 599, Bus P211, , \"]/android.view.View[1]")).click();
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		driver.findElement(AppiumBy.accessibilityId("Extended search options")).click();
	}
	
	private void navigatetoServices() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		
		driver.findElement(By.xpath("//android.widget.LinearLayout[@content-desc=\"Services \"]/android.widget.LinearLayout")).click();
		Thread.sleep(1000);
		
	}
	
	private void navigatetoTMT() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		driver.findElement(AppiumBy.accessibilityId("Home Define address")).click();
		Thread.sleep(1000);
		
	}
	
	private void navigateToTripResults() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.id("android:id/button1")).click();
		WebElement EditText = driver.findElement(By.id("de.hafas.android.translink:id/input_location_name"));
		EditText.sendKeys("Ramsden Street, Carina");
		driver.hideKeyboard();
		Thread.sleep(10000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Ramsden Street, Carina, 11,413 km, , , \"]/android.view.View[1]")).click();
		Thread.sleep(10000);
		driver.findElement(By.id("de.hafas.android.translink:id/min_height_view")).click();
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.view.ViewGroup/android.view.ViewGroup[2]/android.widget.LinearLayout")).click();
		WebElement EditText1 = driver.findElement(By.id("de.hafas.android.translink:id/input_location_name"));
		EditText1.sendKeys("35 Banwell Crescent, Brisbane");
		driver.hideKeyboard();
		Thread.sleep(10000);
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"35 Banwell Crescent, Brisbane, 11,414 km, Favorite No, , , \"]/android.view.View[1]")).click();
		Thread.sleep(10000);
		driver.findElement(By.id("de.hafas.android.translink:id/button_search_default")).click();
		Thread.sleep(2000);
	}
	
	private void navigateToTripDetails() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		Thread.sleep(5000);	
		driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"6:56pm\"])[1]")).click();
		Thread.sleep(5000);	
	}
	
	private void navigateToTrip_results_Walk() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		Thread.sleep(5000);
		...
		driver.switchTo().alert().accept();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.RelativeLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.LinearLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.RelativeLayout[4]/android.widget.Button")).click();
		Thread.sleep(1000);
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		Thread.sleep(1000);
		driver.findElement(AppiumBy.accessibilityId("Results for: Walk .")).click();
		Thread.sleep(1000);
	}
	
	private void navigateToTrip_Details_Walk() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.id("de.hafas.android.translink:id/haf_connection_view")).click();
		Thread.sleep(1000);
	}
	
	private void navigateToTrip_results_Bike() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		driver.findElement(AppiumBy.accessibilityId("Results for: Bike .")).click();
		Thread.sleep(1000);
	}
	
	private void navigateToTrip_Details_Bike() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.id("de.hafas.android.translink:id/haf_connection_view")).click();
		Thread.sleep(1000);
	...
	private void navigateToMap() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
	...
	private void navigateToDeparturesResultsPage() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.id("de.hafas.android.translink:id/input_station")).click();
		WebElement EditText = driver.findElement(By.id("de.hafas.android.translink:id/input_location_name"));
		EditText.sendKeys("Stanley Rd at Vince");
		driver.hideKeyboard();
		Thread.sleep(20000);
	...
	private void navigateToRouteDetailsPage() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.id("de.hafas.android.translink:id/text_line_name")).click();
		Thread.sleep(5000);
	}
	
	private void navigateToDeparturesInfoPage() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(By.xpath("//android.widget.LinearLayout[@content-desc=\"Info\"]/android.widget.TextView")).click();
		Thread.sleep(5000);
	}
	private void navigateToAlarmsPage() throws InterruptedException {
	    // Logic to ensure the app is on the Home screen
	    // E.g., clicking the "Home" icon or using the back button
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
	...
	public void accessibilityTest() throws InterruptedException, IOException
    {
    	...
    	//performChecksForScreen("TripPlanner_Requestpage");
    	navigateVia();
    	//performChecksForScreen("TripPlanner_VIApage");
    	navigateRequestOptions();
    	//performChecksForScreen("TripPlanner_Requestoptions");
    	navigatetoServices();
    	//performChecksForScreen("TripPlanner_Services");
    	navigatetoTMT();
    	//performChecksForScreen("TMT");
    	navigateEnterLocation();
    	//performChecksForScreen("TripPlanner_Enterlocation");
    	navigateToStopsNearByPage();
    	//performChecksForScreen("Enterlocation_StopsNearby");
    	navigateToTripResults();
    	//performChecksForScreen("TripPlanner_TripResults");
    	navigateToTripDetails();
    	navigateToRouteDetailsPage();
    	//performChecksForScreen("RouteDetails");
    	//performChecksForScreen("TripPlanner_TripDetails");
    	navigateToTrip_results_Walk();
    	//performChecksForScreen("TripPlanner_TripResults_Walk");
    	navigateToTrip_Details_Walk();
    	//performChecksForScreen("TripPlanner_TripDetails_Walk");
    	navigateToTrip_results_Bike();
    	//performChecksForScreen("TripPlanner_TripResults_Bike");
    	navigateToTrip_Details_Bike();
    	//performChecksForScreen("TripPlanner_TripDetails_Bike");
    	navigateToMap();
    	//performChecksForScreen("Map Settings");
    	navigateToNearByListPage();
    	//performChecksForScreen("NearByList");
    	navigateToMapMaterialPage();
    	//performChecksForScreen("MapMaterial");
    	navigateToMorePage();
    	//performChecksForScreen("More");
    	navigateToDeparturesPage();
    	//performChecksForScreen("Departures");
    	navigateToDeparturesResultsPage();
    	//performChecksForScreen("Departures_Results");
    	navigateToDeparturesInfoPage();
    	//performChecksForScreen("Departures_Info");
    	navigateToMyTripsPage();
    	performChecksForScreen("My Trips");
