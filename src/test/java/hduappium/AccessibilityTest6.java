...
public class AccessibilityTest6 extends Baseclass7 {
	...
	public void accessibilityTest() throws InterruptedException, IOException
    {
    	...
    	WebElement ele = driver.findElement(By.xpath("//android.widget.TextView[1]"));
    	Dimension size= getSizeInDp(ele,420);
