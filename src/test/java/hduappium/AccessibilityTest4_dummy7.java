...
public class AccessibilityTest4_dummy7 extends Baseclass10 {
	...
	public void accessibilityTest() throws InterruptedException, IOException
    {
    	...
    	Thread.sleep(5000);
    	driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.LinearLayout[2]/androidx.recyclerview.widget.RecyclerView/android.widget.RelativeLayout[1]")).click();
    	Thread.sleep(5000);
    	collectAllElements();
