...
public class AccessibilityTest4_dummy10 extends Baseclass12 {
	...
	public void accessibilityTest() throws InterruptedException, IOException
    {
    	...
    	if(changeFontSize(0.9f)) {
        	...
        	driver.activateApp("de.hafas.android.standard4");
        	performChecksForScreen1("HomeScreenSmall");
        	//navigateToSideDrawer();
        	//performChecksForScreen("NavigationDrawer");
        	navigateToTripPlannerPage();
        	performChecksForScreen1("TripPlannerSmall");
        	navigateToDeparturesPage();
        	performChecksForScreen1("DeparturesSmall");
        	navigateToMapSettingsPage();
        	performChecksForScreen1("MapSettingsSmall");
        	navigateToLocationSearchPage();
        	performChecksForScreen1("LocationSearchSmall");
        	navigateToStopsNearByPage();
        	performChecksForScreen1("StopsNearbySmall");
        	navigateToPOINearByPage();
        	performChecksForScreen1("POINearBySmall");
        	navigateToNearByListPage();
        	performChecksForScreen1("NearByListSmall");
        	navigateToMapMaterialPage();
        	performChecksForScreen1("MapMaterialSmall");
        	navigateToAlarmPage();
        	performChecksForScreen1("AlarmsSmall");
        	navigateToAlarmsHistoryPage();
        	performChecksForScreen1("AlarmsHistorySmall");
        	navigateToMyTripsPage();
        	performChecksForScreen1("MyTripsSmall");
        	navigateToMyTripsEndedPage();
        	performChecksForScreen1("MyTripsEndedSmall");
        	navigateToEventsPage();
        	performChecksForScreen1("EventsSmall");
        	navigateToNewsPage();
        	performChecksForScreen1("NewsSmall");
        	navigateToSettingsPage();
        	performChecksForScreen1("SettingsSmall");
        	navigateToLegalNoticePage();
        	performChecksForScreen1("LegalNoticeSmall");
        	navigateToNetworkMapsPage();
        	performChecksForScreen1("NetworkMapsSmall");
             // Repeat the checks for the new font size
        }
